...
| [20260421-inactive-session-reply-buffering/](20260421-inactive-session-reply-buffering/README.md) | 완료 | 비활성 세션 reply 에 `[label]` prefix 자동 주입 + pin 에 세션별 count. MCP 서버가 직접 전송 (Tag-only 설계) |
| [20260421-multi-session-ux-improvements/](20260421-multi-session-ux-improvements/README.md) | 완료 | /new label/cwd 버그 수정 + 자동 전환 + multi-pin carousel (실제 메시지 pin) + read-on-leave 시멘틱 |
